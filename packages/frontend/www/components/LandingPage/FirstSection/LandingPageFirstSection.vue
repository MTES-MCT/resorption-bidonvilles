<template>
    <div id="plateforme">
        <img width="1024" height="322" class="full-width mx-auto" src="~/assets/img/LandingPage/FirstSection/resorption-bidonvilles-dessin.jpg" alt="Illustration dessinée d'un bidonville et de ses habitant(e)s" />
        <div class="pt-24">
        ...
        <div>
            ...
            <div class="md:flex md:flex-row mt-16">
                <LandingPageContextImage :label="$t('landingPage.firstSection.before')">
                    <img width="430" height="319" v-if="$i18n.locale === 'fr'" src="~/assets/img/LandingPage/FirstSection/fr/before-fr.jpg" alt="Illustration dessinée de l'organisation de la politique de résorption sans la plateforme" />
                    <img width="430" height="319" v-if="$i18n.locale === 'en'" src="~/assets/img/LandingPage/FirstSection/en/before-en.png" alt="Drawn illustration" />
                    <img width="430" height="319" v-if="$i18n.locale === 'bg'" src="~/assets/img/LandingPage/FirstSection/bg/before-bg.png" alt="Drawn illustration" />
                    <img width="430" height="319" v-if="$i18n.locale === 'ro'" src="~/assets/img/LandingPage/FirstSection/ro/before-ro.png" alt="Drawn illustration" />
                ...
                <LandingPageContextImage :label="$t('landingPage.firstSection.after')">
                    <img width="430" height="319" v-if="$i18n.locale === 'fr'" src="~/assets/img/LandingPage/FirstSection/fr/after-fr.jpg" alt="Illustration dessinée de l'organisation de la politique de résorption avec la plateforme" />
                    <img width="430" height="319" v-if="$i18n.locale === 'en'" src="~/assets/img/LandingPage/FirstSection/en/after-en.png" alt="Drawn illustration" />
                    <img width="430" height="319" v-if="$i18n.locale === 'bg'" src="~/assets/img/LandingPage/FirstSection/bg/after-bg.png" alt="Drawn illustration" />
                    <img width="430" height="319" v-if="$i18n.locale === 'ro'" src="~/assets/img/LandingPage/FirstSection/ro/after-ro.png" alt="Drawn illustration" />
                </LandingPageContextImage>
            </div>
