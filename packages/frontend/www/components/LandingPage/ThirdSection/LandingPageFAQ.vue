            ...
            <AccordionItem id="2">
                ...
                <template v-slot:content>
                    ...
                    <p class="mt-6">
                        ...
                        l'administrateur local peut étendre ses accès et ouvrir
                        la possibilité de mettre à jour, créer ou déclarer la
                        fermeture d'un site.
                    </p>
                </template>
            </AccordionItem>
            ...
            <AccordionItem id="4">
                ...
                <template v-slot:content>
                    ...
                    <ul class="list-disc pl-4">
                        <li>
                            <span class="font-bold">rendre visible</span> la
            ...
            <AccordionItem id="6">
                ...
                <template v-slot:content>
                    ...
                    <ul class="list-disc pl-4">
                        ...
                        <li>
                            une
                            <span class="font-bold">complémentarité</span> aux
                            outils de suivi individuels existants
                        </li>
                        <li>
                    ...
                    <p class="mt-6">
                        <video preload="none" poster="~/assets/img/LandingPage/ThirdSection/temoignage_utilisateur_1.png"
                            controls>
                            <source src="~/assets/video/temoignage_utilisateur_1.mp4" type="video/mp4" />
