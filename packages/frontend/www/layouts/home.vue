<template>
    <Layout>
        <template v-slot:anchors v-if="$i18n.locale === 'fr'">
            ...
            <a href="https://blog.resorption-bidonvilles.dihal.gouv.fr" target="_blank" aria-label="Accéder au blog"> Blog <i class="text-xs fas fa-external-link-alt" aria-hidden="true"></i></a>
        </template>
