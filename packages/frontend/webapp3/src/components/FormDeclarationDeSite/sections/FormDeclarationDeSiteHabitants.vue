<template>
    <FormSection id="habitants">
        ...
        <FormParagraph title="Combien y a-t-il de caravanes et d'habitats auto-construits sur le site ?">
            <InputCaravans />
        </FormParagraph>

        <FormParagraph title="Quel est le statut du diagnostic social ?" showMandatoryStar>
            <InputCensusStatus />
        ...
        <FormParagraph title="Tout ou partie des habitants viennent-ils d'un ou plusieurs sites du territoire ?"
            showMandatoryStar>
            ...
            <div class="ml-12" v-if="values.is_reinstallation === 1">
                ...
                <InputShantytowns v-if="location?.departement" :departement="location.departement" :id="townId" />
                <p v-else>
                    <InputLabel label="Site(s) d'origine des habitant(e)s"
