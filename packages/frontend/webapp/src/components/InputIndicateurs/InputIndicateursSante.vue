...
import IndicateursLabelSante from "@/components/IndicateursLabel/IndicateursLabelSante.vue";

const healthInputs = computed(() => {
    return sections.find(({ id }) => id === "sante").inputs;
});
