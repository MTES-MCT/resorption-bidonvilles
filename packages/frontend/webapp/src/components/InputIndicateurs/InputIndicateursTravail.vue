...
import IndicateursLabelTravail from "@/components/IndicateursLabel/IndicateursLabelTravail.vue";

const workInputs = computed(() => {
    return sections.find(({ id }) => id === "travail").inputs;
});
