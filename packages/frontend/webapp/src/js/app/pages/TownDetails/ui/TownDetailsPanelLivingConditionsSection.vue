      ...
      >
        ...
        >
          <div>
            ...
            <span
              v-if="
                status.unknown.length &&
                  (status.negative.length || status.positive.length)
              "
              >et</span
            >
            <span v-if="status.unknown.length">
              ...
              non renseignée{{ status.unknown.length > 1 ? "s" : "" }}
            </span>
          </div>
          <div>
            <Button
        ...
        <div v-if="!collapsed">
          <TownDetailsPanelLivingConditionsDetails
            type="negative"
            :cypressName="cypressDetailsPrefix + '_details_negative'"
            :details="status.negative"
          />
          <TownDetailsPanelLivingConditionsDetails
            type="positive"
            :cypressName="cypressDetailsPrefix + '_details_positive'"
