            ...
            <PrivateContainer class="flex items-center">
                <div class="leftColumnWidth text-sm">
                    ...
                    <TownDetailsNewCommentLeftColumn
                        ...
                        description="Ne pas citer l’identité des individus (Nom, âge, sexe, origine…), ni les infos relatives à d'éventuelles condamnations judiciaires. Ne pas tenir de propos à visée insultante, discriminatoire, raciste, etc."
                    ></TownDetailsNewCommentLeftColumn>
                </div>
