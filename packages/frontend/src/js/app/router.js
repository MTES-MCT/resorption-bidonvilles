...
import LegalMentions from "#app/pages/LegalMentions/index.vue";
...
const router = new VueRouter({
    ...
    routes: [
        ...
        },
        {
            ...
            beforeEnter: guardians.anonymous,
            meta: {
                title: "Résorption-bidonvilles — Statistiques publiques"
            }
        },
        {
            path: "/connexion",
        ...
        },
        {
            ...
            beforeEnter: (to, from, next) => {
                store.dispatch("user/logout", Vue.prototype.$piwik);
                next("/");
            },
            meta: {
                analyticsIgnore: true
        ...
        },
        {
            ...
            meta: {
                title: "Résorption-bidonvilles — Mentions légales"
            }
        },
        {
            meta: {
