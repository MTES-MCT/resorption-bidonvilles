...
export { default as DsfrComplexAutocomplete } from './components/Input/DsfrComplexAutocomplete.vue';
...
export { default as DsfrSort } from './components/Dsfr/DsfrSort.vue';
export { default as DsfrFiltre } from './components/Dsfr/DsfrFiltre.vue';
