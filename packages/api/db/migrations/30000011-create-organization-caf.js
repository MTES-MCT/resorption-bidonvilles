module.exports = {
    async up(queryInterface) {
        ...
        const [
            ...
            queryInterface.sequelize.query(
                ...
                VALUES ('caf', 'Caisse d''allocations familiales', 'Caisses d''allocations familiales', 'CAF', 'public_establishment', 'collaborator')
        ...
        await queryInterface.bulkInsert(
            ...
            departements.map(({ code, name }) => ({
                name: `Caisse d'allocations familiales - ${name}`,
                abbreviation: `CAF - ${name}`,
                active: true,
    ...
    async down(queryInterface) {
        ...
        const [{ organization_type_id }] = await queryInterface.sequelize.query(
            'SELECT organization_type_id FROM organization_types WHERE uid = \'caf\'',
            {
                type: queryInterface.sequelize.QueryTypes.SELECT,
                transaction,
            },
