module.exports = [
    ...
    SELECT
        ...
        CASE
            WHEN location_type = 'nation' then null
            WHEN location_type = 'epci' then epci_departements.departements
            WHEN location_type IN ('city', 'departement') then array[departement_code]
            ELSE array[]::varchar[]
        END AS "departements",
        CASE
            WHEN location_type = 'nation' then null
        ...
        END AS "actions"
    FROM localized_organizations
    LEFT JOIN epci_departements ON localized_organizations.epci_code = epci_departements.fk_epci`,
];
