...
FROM (
    ...
    SELECT
        ...
        CASE user_permission_options.fk_option
            ...
            WHEN 'access_action_finances' THEN 'access'
        END AS fk_feature,
        ...
        CASE user_permission_options.fk_option
            ...
            WHEN 'access_action_finances' THEN 'action_finances'
        END AS fk_entity,
        ...
        CASE
            ...
            WHEN user_permission_options.fk_option = 'access_action_finances' THEN 'nation'
            ELSE intervention_areas.type
        END AS type,

        CASE
            WHEN user_permission_options.fk_option = 'access_action_finances' THEN NULL
            ELSE intervention_areas.fk_region
        END AS fk_region,
