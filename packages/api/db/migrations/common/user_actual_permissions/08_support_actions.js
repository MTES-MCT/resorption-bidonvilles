            ...
            FROM (
                SELECT
                    ...
                    CASE
                        ...
                        WHEN user_permissions.is_cumulative IS FALSE THEN attachment_locations.actions
                        WHEN features.is_writing IS TRUE THEN local_writing_locations.actions || attachment_locations.actions
                        ELSE local_reading_locations.actions || attachment_locations.actions
                    END AS actions
                ...
                SELECT
                    ...
                    CASE
                        ...
                        WHEN role_permissions.allow_all IS TRUE THEN NULL
                        WHEN local_writing_locations.actions IS NULL THEN NULL
                        WHEN features.is_writing IS TRUE THEN local_writing_locations.actions
