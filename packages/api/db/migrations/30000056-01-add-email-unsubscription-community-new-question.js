module.exports = {
    up: queryInterface => queryInterface.sequelize.query(
        "ALTER TYPE enum_user_email_subscriptions_email_subscription ADD VALUE 'community_new_question'",
    ),
            ...
            await Promise.all([
                ...
                queryInterface.sequelize.query(
                    `CREATE TYPE enum_user_email_subscriptions_email_subscription_new AS ENUM ('weekly_summary', 'comment_notification', 
                        'action_comment_notification', 'shantytown_closure', 'shantytown_creation', 'community_new_answer')`,
                    {
                        transaction,
                    },
                ),
