...
export default function mergeMetrics(hash: ActionHash, metrics: ActionMetricsRow[]): void {
    metrics.forEach((row) => {
        ...
        hash[row.action_id].metrics.push({
            ...
            scolaire_mineurs_moins_de_trois_ans: row.scolaire_mineurs_moins_de_trois_ans,
            scolaire_mineurs_trois_ans_et_plus: row.scolaire_mineurs_trois_ans_et_plus,
            scolaire_mediation_moins_de_trois_ans: row.scolaire_mediation_moins_de_trois_ans,
            scolaire_mediation_trois_ans_et_plus: row.scolaire_mediation_trois_ans_et_plus,
            ...
            scolaire_mineur_scolarise_dans_annee: row.scolaire_mineur_scolarise_dans_annee,
