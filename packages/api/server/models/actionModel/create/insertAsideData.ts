...
import insertAddresses from './insertAddresses';
...
export default function insertAsideData(actionId: number, authorId: number, data: ActionEnrichedInput, transaction: Transaction) {
