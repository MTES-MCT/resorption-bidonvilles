...
export default function serializeComment(comment: shantytownCommentRowWithTags): ShantytownRawComment {
    return ({
        id: comment.commentId,
        description: comment.commentDescription,
        createdAt: comment.commentCreatedAt === null ? null : (comment.commentCreatedAt.getTime() / 1000),
