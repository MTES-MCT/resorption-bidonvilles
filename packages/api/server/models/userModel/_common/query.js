...
module.exports = async (where = [], filters, user = null, feature) => {
    ...
    const users = await sequelize.query(
        ...
        users_roles_regular."name" AS user_role_name,
        ...
        organizations_roles_regular.name AS organization_type_role_name,
    ...
    LEFT JOIN
        roles_regular AS organizations_roles_regular ON organization_types.fk_role = organizations_roles_regular.role_id
    LEFT JOIN
        roles_regular AS users_roles_regular ON users.fk_role_regular = users_roles_regular.role_id
