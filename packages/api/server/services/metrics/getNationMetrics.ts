...
export default async (user: User, argFrom: Date, argTo: Date):Promise<NationMetricsList> => {
    ...
    data.forEach((row, index) => {
        ...
        if (incrementTo && row.closed_at === null) {
            ...
            franceData.metrics.number_of_persons_european_10_and_over.to += row.population_total >= 10 && row.origins !== null && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
            franceData.metrics.number_of_towns.to += 1;
            franceData.metrics.number_of_towns_european_10_and_over.to += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? 1 : 0;
            ...
            if (row.is_oversea) {
                ...
                outremerData.metrics.number_of_persons_european_10_and_over.to += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
                outremerData.metrics.number_of_towns.to += 1;
                outremerData.metrics.number_of_towns_european_10_and_over.to += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? 1 : 0;
                ...
                metropoleData.metrics.number_of_persons_european_10_and_over.to += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
                metropoleData.metrics.number_of_towns.to += 1;
                metropoleData.metrics.number_of_towns_european_10_and_over.to += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? 1 : 0;
            ...
            hashRegions[row.region_code].metrics.number_of_persons_european_10_and_over.to += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
            ...
            hashRegions[row.region_code].children[hashDepartements[row.departement_code]].metrics.number_of_persons_european_10_and_over.to += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
        ...
        if (incrementFrom) {
            ...
            franceData.metrics.number_of_persons_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
            franceData.metrics.number_of_towns.from += 1;
            franceData.metrics.number_of_towns_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? 1 : 0;
            ...
            if (row.is_oversea) {
                ...
                metropoleData.metrics.number_of_persons_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
                metropoleData.metrics.number_of_towns.from += 1;
                metropoleData.metrics.number_of_towns_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? 1 : 0;
            ...
            hashRegions[row.region_code].metrics.number_of_persons_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
            hashRegions[row.region_code].metrics.number_of_towns.from += 1;
            hashRegions[row.region_code].metrics.number_of_towns_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? 1 : 0;
            ...
            hashRegions[row.region_code].children[hashDepartements[row.departement_code]].metrics.number_of_persons_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? row.population_total : 0;
            hashRegions[row.region_code].children[hashDepartements[row.departement_code]].metrics.number_of_towns.from += 1;
            hashRegions[row.region_code].children[hashDepartements[row.departement_code]].metrics.number_of_towns_european_10_and_over.from += row.population_total >= 10 && row.origins !== null  && Array.isArray(row.origins) && !row.origins.includes('other') ? 1 : 0;
