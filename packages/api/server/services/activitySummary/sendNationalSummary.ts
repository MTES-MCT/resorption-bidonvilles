...
export default async (argFrom: Date, argTo: Date, questionSummary: QuestionNationalSummary, argSummaries: ActivityNationalSummary, subscribers: Array<SerializedUser>): Promise<any> => {
