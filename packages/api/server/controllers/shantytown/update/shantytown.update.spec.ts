        ...
        it('met à jour le site', async () => {
            expect(dependencies.update).to.have.been.calledOnceWithExactly(
                ...
                1,
                {
                    ...
                    evacuation_police_status: input.body.evacuation_police_status,
                    evacuation_police_requested_at: input.body.evacuation_police_requested_at || null,
                    evacuation_police_granted_at: input.body.evacuation_police_granted_at || null,
                    evacuation_bailiff: input.body.evacuation_bailiff,
                    ...
                    insalubrity_police_status: input.body.insalubrity_police_status || null,
                    insalubrity_police_requested_at: input.body.insalubrity_police_requested_at || null,
                    insalubrity_police_granted_at: input.body.insalubrity_police_granted_at || null,
                    insalubrity_bailiff: input.body.insalubrity_bailiff,
