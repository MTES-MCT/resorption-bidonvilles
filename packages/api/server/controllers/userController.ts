...
import sanitize from '#server/controllers/userController/helpers/sanitize';
import checkPassword from '#server/controllers/userController/helpers/checkPassword';
import validate from '#server/controllers/userController/helpers/validate';
...
const { auth: authConfig, mattermost } = config;
