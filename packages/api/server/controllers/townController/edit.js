        ...
        await sequelize.transaction(async (transaction) => {
            ...
            const updatedTown = Object.assign(
                ...
                req.user.permissions.shantytown.update.data_justice === true
                    ...
                    : {
                        owner_complaint: town.ownerComplaint,
                        justice_procedure: town.justiceProcedure,
                        justice_rendered: town.justiceRendered,
                        justice_rendered_by: town.justiceRenderedBy,
                        justice_rendered_at: town.justiceRenderedAt,
                        justice_challenged: town.justiceChallenged,
                        police_status: town.policeStatus,
                        police_requested_at: town.policeRequestedAt,
                        police_granted_at: town.policeGrantedAt,
            ...
            if (req.body.social_origins.length > 0) {
                await sequelize.query(
                    ...
                    VALUES
                        ${req.body.social_origins.map(id => `(:id, ${id})`).join(', ')}`,
                    {
                        replacements: {
                            id: req.params.id,
                        },
