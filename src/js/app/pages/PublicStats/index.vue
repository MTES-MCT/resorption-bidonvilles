        ...
        <PublicContainer class="py-16">
            ...
            <StatsSection title="Fréquence de mise à jour" class="mt-16">
                ...
                <template v-slot:default>
                    ...
                    <StatsBlock :title="meanTimeBeforeClosingDeclaration" subtitle="jours entre la fermeture du site et sa déclaration" info="En moyenne, depuis le 01/09/2019." />
                    <StatsBlock :title="numberOfShantytownOperations" subtitle="bidonvilles ou squats mis à jour" info="Toutes opérations confondues : création, modification, fermeture" />
                </template>
            </StatsSection>
        </PublicContainer>
    </PublicLayout>
