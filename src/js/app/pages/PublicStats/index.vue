<template>
  <PublicLayout :sticky-header="false">
    <PublicContainer class="py-16">
      ...
      >
        ...
        <StatsBlock
          ...
          :info="numberOfPublicEstablishments+' services de l\'État, '+numberOfTerritorialCollectivities+ ' collectivités territoriales, '+numberOfAssociations+' associations'"
        />
        <StatsBlock
      ...
      >
        <template #info>
          <span class="text-secondary"><font-awesome-icon icon="sync" /></span> La mise à jour régulière des données garantissent des informations justes à tous les acteurs.
        </template>
        <template #default>
          <StatsBlock
