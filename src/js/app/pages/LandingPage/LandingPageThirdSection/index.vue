    ...
    <div class="mt-32">
      ...
      <div class="max-w-screen-sm mx-auto">
        <div class="mt-4">
          ...
          >{{ $t('landingPage.thirdSection.secondParagraph.body.link1') }}</a>,
        ...
        <div class="mt-8">
          ...
          <ul class="list-disc ml-8">
            <li>
              ...
              >{{ $t('landingPage.thirdSection.secondParagraph.items.1.link') }}</a> {{ $t('landingPage.thirdSection.secondParagraph.items.1.text') }}
            </li>
            ...
            <li>
              ...
              >{{ $t('landingPage.thirdSection.secondParagraph.items.3.link') }}</a> {{ $t('landingPage.thirdSection.secondParagraph.items.3.text') }}
            </li>
          </ul>
        </div>

        <div class="flex flex-row flex-wrap items-center justify-between mt-8">
          <a href="https://solidarites-sante.gouv.fr/"><img
            class="h-24 m-2"
            src="./assets/logo-gouvernement.jpg"
          ></a>
          <a href="https://ec.europa.eu/info/index_en"><img
            class="h-24 my-2"
            src="./assets/logo-commission-europenne.png"
          ></a>
        </div>
        <div class="flex flex-row flex-wrap items-center justify-between mt-8">
          <a href="https://beta.gouv.fr/approche/incubateurs/mtes.html"><img
            class="h-24 m-2"
            src="./assets/logo-fabrique-numerique.png"
          ></a>
          <a href="https://beta.gouv.fr/"><img
            class="h-20 m-2"
            src="./assets/logo_beta-gouv-fr.jpg"
          ></a>
          <a href="https://entrepreneur-interet-general.etalab.gouv.fr/defis/2019/resorption-bidonvilles.html"><img
            class="h-16 m-2"
