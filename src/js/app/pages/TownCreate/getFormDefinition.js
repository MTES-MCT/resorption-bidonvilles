...
export const getCharacteristicsInputs = () => {
    const {
...
export const getPeopleSectionInputs = () => {
    const {
...
export const getLifeConditionsInputs = () => {
    const {
...
export const getDataJusticeInputs = () => ({
    ownerComplaint: {
        type: 'radio',
        options: yesNoValues,
        ...
        steps: [
            {
                ...
                sections: [
                    ...[
                        {
                            ...
                            inputs: getCharacteristicsInputs(),
                        },
                        {
                            title: 'Habitants',
                    ...
                    ...hasPermission('shantytown.create.data_justice')
                        ? [{ title: "Procédure judiciaire d'expulsion des occupants", inputs: getDataJusticeInputs() }]
                        : [],
