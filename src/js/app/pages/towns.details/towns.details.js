  ...
  methods: {
    ...
    checkClickOutsideAside(event) {
      if (
        (!this.$refs.commentDeletionPopin ||
          !this.$refs.commentDeletionPopin.$el.contains(event.target)) &&
    ...
    submit() {
      ...
      edit(this.town.id, {
        ...
        census_conducted_at:
          ["scheduled", "done"].indexOf(this.edit.census_status) !== -1
        ...
        police_requested_at:
          ["requested", "granted"].indexOf(this.edit.police_status) !== -1
        ...
        solutions: Object.keys(this.edit.solutions)
          ...
          .map(key => ({
            ...
            peopleAffected: this.edit.solutions[key].peopleAffected
              ? parseInt(this.edit.solutions[key].peopleAffected, 10)
              : null,
            householdsAffected: this.edit.solutions[key].householdsAffected
              ? parseInt(this.edit.solutions[key].householdsAffected, 10)
              : null
          }))
      })
        .then(() => {
