<template>
    <div :class="['fixed z-40 inset-0 transform transition ease-in-out duration-300', isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none']">
        ...
        <div class="flex items-center justify-center min-h-screen">
            <div role="dialog" ref="dialog" aria-modal="true" aria-labelledby="modal-headline" class="opacity-100 z-50 max-w-xl shadow-xl overflow-hidden rounded-lg">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex justify-between">
                        <div class="text-display-md"><slot name="header" /></div>
                        <Button variant="text" icon="times" @click="closeModal" />
                    </div>
